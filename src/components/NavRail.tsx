...
const NAV_ITEMS: { view: AppView; label: string; index: string }[] = [
  { view: 'map', label: 'Map', index: 'M' },
  { view: 'approvals', label: 'Approvals', index: 'A' },
  { view: 'activity', label: 'Activity', index: 'L' },
  { view: 'agents', label: 'Agents', index: 'G' },
  { view: 'documents', label: 'Documents', index: 'D' },
]
